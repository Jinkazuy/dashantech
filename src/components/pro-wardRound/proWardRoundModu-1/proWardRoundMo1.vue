<template>
  <div
    :class="[
      'pro-WardRound-modu-1',
      'w100',
      'clearfix',
      mob ? 'pro-WardRound-modu-1-mob' : ''
    ]"
  >
    <div class="container">
      <div class="pro-follow-mo1-tit">
        <h1>大善移动医生查房系统</h1>
        <p>
          大善移动医生查房系统通过与众多医院已有的相关信息系统进行对接，实现了在移动终端设备上查看病人的基本信息、医嘱信息、电子病历、检查信息、检验信息、护理信息，同时还支持医生在终端设备上通过手写、语音以及图片的方式进行备注，很好地将医生的信息系统延伸到病人床边。<br>具体功能包括:床位列表、医嘱录入、电子申请单、医技报告、生命体征、手术安排信息、会诊通知、智能提醒等。
        </p>
      </div>
...
<script>
// 引入banner插画组件
import bannerIllusCont from "../../../../public/images/ydys.png";
import bannerImg from "../../../components/layouts/banner-img/banner-img";
export default {
  name: "proWardRoundModu1",
  props: ["mob"],
  data() {
    return {
      // banner插画主体
